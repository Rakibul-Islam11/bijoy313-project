    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center px-4 py-8">
            <div className="w-full max-w-3xl bg-white p-8 rounded-2xl shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full text-sm p-2 border border-gray-300 rounded-lg file:bg-blue-50 file:text-blue-700 text-black file:font-semibold file:border-none file:rounded-full"
                        />
                        {photoPreview && (
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-600 text-white py-3 font-semibold rounded-lg hover:bg-blue-700 transition duration-300"
                    >
                        Update Profile
                    </button>
                </form>
                ...
                {message && (
                    <p className={`mt-6 text-center text-sm font-medium ${message.includes("Failed") ? "text-red-600" : "text-green-600"}`}>
                        {message}
                    </p>
                )}
            </div>
